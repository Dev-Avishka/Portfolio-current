    ...
    return (
        <div className="app">
            <div className='cards'>
                ...
                <Card Title={'S-Quiz'} image_path={'projects/sq.png'} description={'Squiz is a project I made for an event conducted at University to have our own experience '} link={'https://github.com/Dev-Avishka/s-quiz'}></Card>
                <Card Title={'Service Mate'} image_path={'projects/sm.png'} description={'An app I made to remind you to service your car and keep details of it.'} link={'https://github.com/Dev-Avishka/ServiceMate'}></Card>
            </div>
